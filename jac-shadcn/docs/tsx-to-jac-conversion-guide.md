...
A comprehensive guide for converting shadcn/ui React components from TypeScript (`.tsx`) to the Jac language (`.cl.jac`). This documents every pattern, pitfall, and workaround discovered during the jac-way project.
